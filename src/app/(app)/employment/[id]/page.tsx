  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle={`${new Date(startDate).toLocaleDateString("he-IL", { timeZone: "Asia/Jerusalem" })} - ${new Date(endDate).toLocaleDateString("he-IL", { timeZone: "Asia/Jerusalem" })} | ${dayCount} ימים | ${employment.totalDays} ימי מילואים`}
