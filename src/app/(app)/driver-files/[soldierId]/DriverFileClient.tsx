...
import { saveDriverForm, saveLicenseDetails, removeLicensePhoto } from "../actions";
...
function fileImage(file: File, maxW = 900, q = 0.6): Promise<string> {
...
function FieldInput({ f, values, setVal, setGrid }: { f: FieldDef; values: Record<string, unknown>; setVal: (k: string, v: unknown) => void; setGrid: (k: string, row: string, col: string, v: string) => void }) {
