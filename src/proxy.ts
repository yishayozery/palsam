...
const PUBLIC_PREFIXES = ["/login", "/about", "/sign", "/invite", "/_next", "/favicon", "/api/sign", "/api/telegram", "/api/cron", "/api/dispatch-open", "/my-equipment", "/offline", "/verify", "/dispatch-open", "/bot/dispatch", "/transfer-doc", "/counts/share", "/api/_diag"];
